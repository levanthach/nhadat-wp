				...
				<div class="main col-xs-12 col-sm-8 col-md-8">
					<div class="single-post">
						...
						<div class="info-house-land">
							<p><span><i class="fa fa-connectdevelop"></i>Diện tích đất </span>: <?php echo types_render_field("dien-tich-dat");?></p>
							<p><span><i class="fa fa-gg"></i>Loại đất </span>: <?php echo types_render_field("loai-dat");?></p>
							<p><span><i class="fa fa-map-marker"></i>khu vực </span>: <?php echo types_render_field("khu-vuc");?></p>
							<p style="color:red"><span><i class="fa fa-bars"></i>Giá đất </span>: <?php echo types_render_field("gia-dat");?></p>
						</div>
